% [] = leap_figure_axes_control(varargin)
%
% a function intended to be called to allow the Leap Motion controller 
% to move the camera in a Matlab figure.
%
% no useful arguments right now.
%
% copyright 2014 - 2017 Dani Brake
